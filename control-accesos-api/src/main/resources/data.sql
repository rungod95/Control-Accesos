INSERT INTO user_account (username, password, role, full_name, enabled, qr_code)
SELECT 'admin', '$2a$10$.JAPy7Dt9nAsFY7Wmv4M7OViQmFbwKUfKcxipu7zY4oZInHKEy/oi', 'ADMIN', 'Administrador Mina', true, 'QR-ADMIN-001'
WHERE NOT EXISTS (SELECT 1 FROM user_account WHERE username = 'admin');

INSERT INTO user_account (username, password, role, full_name, enabled, qr_code)
SELECT 'operario1', '$2a$10$AQsGrAh0dLffSewUzcnCjuQtGSaZTwmGD6P719eSB52VCaCvVWbRm', 'TRABAJADOR', 'Operario Cargadero', true, 'QR-TRAB-001'
WHERE NOT EXISTS (SELECT 1 FROM user_account WHERE username = 'operario1');
